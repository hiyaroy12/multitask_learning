...
tf.app.flags.DEFINE_string('gpu_list', '4,5,7,8,9', '')
tf.app.flags.DEFINE_string('checkpoint_path', 'checkpoints_arroyo/', '')
tf.app.flags.DEFINE_string('logs_path', 'logs_arroyo/', '')
...
tf.app.flags.DEFINE_string('training_data_path', 'pascal_train_arroyo.tfrecords', '')
# tf.app.flags.DEFINE_string('training_data_path', 'data/pascal_train.tfrecords', '') 
tf.app.flags.DEFINE_string('pretrained_model_path', 'saved_models/resnet_v1_101.ckpt', '')
...
def main(argv=None):
    ...
    class_labels = [x for x in pascal_voc_lut.keys()]
